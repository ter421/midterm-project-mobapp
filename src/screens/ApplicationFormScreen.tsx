...
import { useFeedbackModal } from '../context/FeedbackModalContext'; // ← replaces App.tsx import
...
const ApplicationFormScreen: React.FC = () => {
  ...
  const { showFeedbackModal }           = useFeedbackModal(); // ← clean context hook
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView
          ...
          <View style={[styles.formCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
            ...
            {/*
              touched={true} here is correct — the hook's visibleErrors already gates
              which errors are shown based on the touched state tracked inside useApplicationForm.
              Passing a derived boolean from formData was bypassing that logic entirely.
            */}
            <FormInput
              label="Full Name"
              ...
              placeholder="e.g. John Lowell Prado"
            ...
            <FormInput
              ...
              placeholder="e.g. lowell@email.com"
              error={errors.email}
              touched={true}
