...
// Singleton setter — ApplicationFormScreen calls this directly
let _showFeedback: ((payload: FeedbackPayload) => void) | null = null;
export const showFeedbackModal = (payload: FeedbackPayload) => {
  _showFeedback?.(payload);
};
...
const FeedbackModal: React.FC = () => {
  ...
  // Register the singleton setter on mount
  React.useEffect(() => {
    _showFeedback = (p) => {
      setPayload(p);
      setStep('success');
        ...
        <View style={[s.card, { backgroundColor: theme.card }]}>
          ...
          {step === 'success' && (
            <>
              ...
              <Text style={[s.title, { color: theme.text.primary }]}>Application Submitted!</Text>
          ...
          {step === 'rating' && (
            <>
              ...
              <Text style={[s.title, { color: theme.text.primary }]}>How was your experience?</Text>
              <Text style={[s.message, { color: theme.text.secondary }]}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.85}>
                <Ionicons name="checkmark-circle-outline" size={16} color={rating > 0 ? '#fff' : theme.text.tertiary} />
          ...
          {step === 'done' && (
            <>
              ...
              <View style={s.starsRow}>
                {[1, 2, 3, 4, 5].map(n => (
                  <Ionicons key={n} name={n <= rating ? 'star' : 'star-outline'} size={34}
...
const createStyles = (theme: any) => StyleSheet.create({
  ...
  badge: {
    ...
    paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, borderWidth: 1, marginBottom: 12,
  },
  badgeText: { fontSize: 14, fontWeight: '700' },
  message: { fontSize: 14, textAlign: 'center', lineHeight: 22, marginBottom: 14 },
  note: {
    flexDirection: 'row', alignItems: 'flex-start', gap: 8,
    padding: 12, borderRadius: 12, borderWidth: 1, marginBottom: 14, width: '100%',
  },
  ...
  primaryBtn: {
    ...
    gap: 8, paddingVertical: 15, borderRadius: 14, width: '100%', marginBottom: 8,
  },
